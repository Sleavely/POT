 ...
 */
    public function rewind()
    {
        ...
        $this->rows = $this->db->SQLquery('SELECT ' . $this->db->tableName('accounts') . '.' . $this->db->fieldName('id') . ' FROM ' . implode(', ', $tables) . $where . $orderBy . $this->db->limit($this->limit, $this->offset) )->fetchAll();
    }
 ...
 */
    public function count()
    {
        ...
        $count = $this->db->SQLquery('SELECT COUNT(' . $this->db->tableName('accounts') . '.' . $this->db->fieldName('id') . ') AS ' . $this->db->fieldName('count') . ' FROM ' . implode(', ', $tables) . $where . $this->db->limit($this->limit, $this->offset) )->fetch();
        return $count['count'];
    }
}
